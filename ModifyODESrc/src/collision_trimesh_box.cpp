  ...
  OBBCache &BoxCache)
{
  ...
  ///////////////////////////////////
  // have we really used this matrix? -- Libin
  ...
  if (TriMesh->doBoxTC) {
    ...
    if (TriMesh->isSingleTriangle)
	  Collider.Collide(*BoxTC, Box, TriMesh->Data->BVTree, null, null);
    else
     ...
     // for single-triangle mesh
     if (TriMesh->isSingleTriangle)
        Collider.Collide(BoxCache, Box, TriMesh->Data->BVTree, null, null);
     else
