...
inline /*float*/dReal Clamp(/*float*/dReal n, /*float*/dReal min, /*float*/dReal max)
{
    if (n < min) return min;
    if (n > max) return max;
    return n;
...
*/
inline /*float*/dReal ClosestPointBetweenSegments(dVector3& p1,
                                         dVector3& q1,
                                         dVector3& p2,
                                         dVector3& q2,
                                         dVector3& c1,
                                         dVector3& c2)
{
    ...
    dVector3 r  = {p1[0] - p2[0],
                   p1[1] - p2[1],
                   p1[2] - p2[2]};
    /*float*/dReal a = dCalcVectorDot3(d1, d1);
    /*float*/dReal e = dCalcVectorDot3(d2, d2);
    /*float*/dReal f = dCalcVectorDot3(d2, r);
    ...
    {
        /*float*/dReal c = dCalcVectorDot3(d1, r);
        if (e <= dEpsilon)
        {
        ...
        else
        {
            ...
            /*float*/dReal b = dCalcVectorDot3(d1, d2);
            /*float*/dReal denom = a*e-b*b; // Always nonnegative
