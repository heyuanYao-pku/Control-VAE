...
// res = a * b, a is 3x3 matrix, b is 3x1 vector
...
// res = a' * b, a is 3x1 vector, b is 3x3 matrix. so res' = b' * a
PURE_INLINE void dMultiplyHelper0_133(dReal *res, const dReal *a, const dReal *b)
{
  dMultiplyHelper1_331(res, b, a);
}

// res = a' * b, where a is 3x3 matrix, b is a column of a 3x3 matrix
...
// res = a * b, a is 3x3 matrix, b is 3x3 matrix
...
// res = a' * b, a is 3x3 matrix, b is 3x3 matrix, so res' = b' * a
