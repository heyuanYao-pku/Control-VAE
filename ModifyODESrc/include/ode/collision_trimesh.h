...
ODE_API void dGeomTriMeshGetOriginTriangle(dGeomID g, int Index, dVector3* v0, dVector3* v1, dVector3* v2);
...
ODE_API void dGeomTriMeshVertexsData(dGeomID g, float *vertexs);
ODE_API void dGeomTriMeshFacesData(dGeomID g, unsigned int* faces);
ODE_API int dGeomTriMeshVertexsNum(dGeomID g);
ODE_API int dGeomTriMeshFacesNum(dGeomID g);
