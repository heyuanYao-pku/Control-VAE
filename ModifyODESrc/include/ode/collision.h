...
/* add by Yulong Zhang
 * copy the position and rotation of geom to another position
 */
ODE_API void dGeomCopyPosRot4Render(dxGeom *g, dxPosR *target_posr);
...
// Add by Zhenhua Song
ODE_API void dGeomGetQuatAndMatNoNorm(dGeomID geom, dQuaternion quat, dMatrix3 mat);
...
// Add by Yulong Zhang
ODE_API int dGeomGetDrawAxisFlag (dGeomID geom);

// Add by Yulong Zhang
ODE_API void dGeomSetDrawAxisFlag (dGeomID geom, int x);
...
// Add by Zhenhua Song
ODE_API int dGeomIsPlaceable(dGeomID geom);

// Add by Zhenhua Song
//ODE_API void dGeomAppendIgnore(dGeomID now_id, dGeomID other_id);

// Add by Zhenhua Song
//ODE_API int dGeomIsIgnore(dGeomID now_id, dGeomID other_id);

// Add by Zhenhua Song
ODE_API int dGeomGetCharacterID(dGeomID g);

// Add by Zhenhua Song
ODE_API void dGeomSetCharacterID(dGeomID g, int character_id);

// Add by Zhenhua Song
ODE_API int dGeomGetIndex(dGeomID g);

// Add by Zhenhua Song
ODE_API void dGeomSetIndex(dGeomID g, int index);
...
// Add by Zhenhua Song
ODE_API void dGeomPlaneGetNearestPointToOrigin(dGeomID g, dVector3 result);

// Add by Zhenhua Song
ODE_API void dGeomPlaneGetQuatFromZAxis(dGeomID g, dQuaternion result);
