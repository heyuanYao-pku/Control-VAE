...
// Add by Zhenhua Song
ODE_API dGeomID dSpaceGetFirstGeom(dSpaceID);

// Add by Zhenhua Song
ODE_API dGeomID dSpaceGetNextGeom(dGeomID geom);

// Add by Zhenhua Song
ODE_API int dSpaceGetPlaceableCount(dSpaceID space);

// Add by Zhenhua Song
ODE_API int dSpaceGetPlaceableAndPlaneCount(dSpaceID space);

// Add by Zhenhua Song
ODE_API void dSpaceResortGeoms(dSpaceID space);
...
// Add by Zhenhua Song
ODE_API void* dSpaceGetData(dSpaceID space);

// Add by Zhenhua Song
ODE_API void dSpaceSetData(dSpaceID space, void * data);
