...
// Add by Zhenhua Song
ODE_API int dWorldStepWithInfo(dWorldID w, dReal stepsize, WorldStepFeatureInfoPtr feature_info);

// Add by Zhenhua Song
ODE_API int dWorldResortJoint(dWorldID w, dReal stepsize, WorldStepFeatureInfoPtr feature_info);
...
// Add by Zhenhua Song
ODE_API dJointID dWorldGetFirstJoint(dWorldID);

// Add by Zhenhua Song
ODE_API dJointID dWorldGetNextJoint(dJointID joint);

// Add by Zhenhua Song
ODE_API int dWorldGetNumJoints(dWorldID w);

// Add by Zhenhua Song
ODE_API int dWorldGetNumBallAndHingeJoints(dWorldID w);

// Add by Zhenhua Song
ODE_API dBodyID dWorldGetFirstBody(dWorldID w);

// Add by Zhenhua Song
ODE_API dBodyID dWorldGetNextBody(dBodyID body);

// Add by Zhenhua Song
ODE_API int dWorldGetNumBody(dWorldID w);
...
// Add by Zhenhua Song
ODE_API void dBodySetRotAndQuatNoNorm(dBodyID, const dMatrix3 R, const dQuaternion q);
...
// Add by Zhenhua Song
ODE_API int dBodyGetNumGeoms(dBodyID b);

// Add by Zhenhua Song
ODE_API unsigned int dBodyGetFlags(dBodyID b);

// Add by Zhenhua Song
ODE_API void dBodyGetInertia(dBodyID b, dReal* out);

// Add by Zhenhua Song
ODE_API void dBodyGetInertiaInv(dBodyID b, dReal* out);

// Add by Zhenhua Song
ODE_API dReal* dBodyGetInitInertia(dBodyID b);

// Add by Zhenhua Song
ODE_API dReal* dBodyGetInitInertiaInv(dBodyID b);

// Add by Zhenhua Song
ODE_API dReal dBodyGetMassValue(dBodyID b);
...
// Add by Zhenhua Song
ODE_API dJointID dJointCreateEmptyBall(dWorldID w, dJointGroupID group);
...
ODE_API dJointID dJointCreateContactMaxForce(dWorldID w, dJointGroupID group, const dContact* c); // Add by ZHenhua Song
...
ODE_API int dJointInGroup(dJointGroupID, dJointID);
...
ODE_API void dJointEnableImplicitDamping(dJointID);
/**
 * @brief Manually enable implicit damping.
 * @ingroup joints
 * @remarks
 * Add by Heyuan Yao
 * DO NOT use it and damping step at same time!!!!
 *
*/

ODE_API void dJointDisableImplicitDamping(dJointID);
...
// Add by Zhenhua Song
ODE_API unsigned int dJointGetHingeFlags(dJointID j);

// Add by Zhenhua Song
ODE_API void dJointGetHingeQRel(dJointID j, dQuaternion q);
...
// Add by Zhenhua Song
ODE_API const dReal* dJointGetBallAnchor1Raw(dJointID j);

// Add by Zhenhua Song
ODE_API const dReal* dJointGetBallAnchor2Raw(dJointID j);
...
// Add by Zhenhua Song
ODE_API const dReal* dJointGetHingeAnchor1Raw(dJointID);

// Add by Zhenhua Song
ODE_API const dReal* dJointGetHingeAnchor2Raw(dJointID);
...
// Add by Zhenhua Song
ODE_API void dJointGetHingeAxis1(dJointID j, dVector3 result);

// Add by Zhenhua Song
ODE_API void dJointGetHingeAxis2(dJointID j, dVector3 result);

// Add by Zhenhua Song
ODE_API void dJointGetHingeAxis1Raw(dJointID j, dVector3 result);

// Add by Zhenhua Song
ODE_API void dJointGetHingeAxis2Raw(dJointID j, dVector3 result);
 ...
 * @ingroup joints
 */
ODE_API void dJointSetKd_arr(dJointID, const dReal * kd);

// Add by Zhenhua Song
ODE_API void dJointSetKd(dJointID, dReal kdx, dReal kdy, dReal kdz);

// Add by Zhenhua Song
ODE_API const dReal * dJointGetKd(dJointID);

// Add by Zhenhua Song
ODE_API dReal dJointGetContactParam(dJointID j, int parameter);

// Add by Zhenhua Song
ODE_API void dJointSetContactParam(dJointID j, int parameter, dReal value);
...
// Add by Zhenhua Song
ODE_API void dSolveLCPWrapper(int n, dReal* A, dReal* x, dReal* b,
    dReal* outer_w, int nub, dReal* lo, dReal* hi, int* findex);

////////////////////////////////////////////
// added by Libin Liu
/**
 * @brief damped world step
 *
 * @param w
 * @param stepsize
 * @return ODE_API
 */
ODE_API int dWorldDampedStep (dWorldID w, dReal stepsize);

// Add by Zhenhua Song
ODE_API int dWorldDampedStepWithInfo(dWorldID w, dReal stepsize, WorldStepFeatureInfoPtr feature_info);
...
* If it is nonzero the joint is allocated in the given joint group.
*/
ODE_API dJointID dJointCreateContact2(dWorldID, dJointGroupID, const dContact *, int donotPushOut);


ODE_API dJointID dJointCreateContact3(dWorldID w, dJointGroupID group, const dContact *c, dReal timestep);
