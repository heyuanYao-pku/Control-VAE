...
#define __OPC_OPTIMIZEDTREE_H__
	...
	#define IMPLEMENT_IMPLICIT_NODE(base_class, volume)														\
		...
		inline_			/*size_t*/udword				GetPrimitive()	const	{ return /*size_t*/udword(mData>>1);				}	\
		/* Stats */																							\
	...
	#define IMPLEMENT_NOLEAF_NODE(base_class, volume)														\
		...
		inline_			/*size_t*/udword				GetPosPrimitive()	const	{ return /*size_t*/udword(mPosData>>1);			}	\
		inline_			/*size_t*/udword				GetNegPrimitive()	const	{ return /*size_t*/udword(mNegData>>1);			}	\
		/* Stats */																							\
		inline_			udword				GetNodeSize()		const	{ return SIZEOFOBJECT;			}	\
																											\
						volume				mAABB;															\
